...
public class KhipuHelper {
    private static final Integer ID_DEL_COBRADOR =95080;//2581;
    private static final String SECRET_DEL_COBRADOR = "7735261977f9dc962e4f7eb8004952984c6ad293";//"0ce9d2d383eb387ddf757fcd9eac8e4c53ee2c1f";


    public static JSONObject createPayment(String subject, String amount, String payerEmail) {
        ...
        try {
            ...
            Log.d("RESPONSE_MESSAGE",conn.getResponseMessage());
            Log.d("RESPONSE_CODE", String.valueOf(conn.getResponseCode()));
